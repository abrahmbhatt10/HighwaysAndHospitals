...
public class OldHighwaysAndHospitals {
    /*
        ...
        for(int i = 0; i < sortedList.length; i++){
            ...
            if(bHighways.containsKey(mostConnectedCity)){
                /*
                    ...
                    Through highway.
                 */
                if(getSubCost(0, hospitalCost, connectedCityNum, highwayCost) == 0) {
    ...
    public static long getMyCost(int n, int numCities, int hospitalCost, int numHighways, int highwayCost)
    {
        ...
        try {
             ...
             */
            n1 = (hospitalCost * numCities);
            n2 = (highwayCost * numHighways);
            n3 = (numHighways+numCities);
            n4 = n - n3;
            n5 = n4 *hospitalCost;
            n6 = n1+n2;
            n7 = n6+n5;
